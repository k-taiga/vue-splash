      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function submit$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              // loading表示
              this.loading = true; // HTML5 の FormData API
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchPhoto: function fetchPhoto() {
      var response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function fetchPhoto$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios.get("/api/photos/".concat(this.id)));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchPhotos: function fetchPhotos() {
      var response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function fetchPhotos$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container--smalll" }, [
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // パスと使用するコンポーネントを紐づける web.phpのようなもの
